...
const TABLE_HEAD = [
  ...
  { id: 'applicants', label: 'Applications', align: 'left' },
...
function applySortFilter({ tableData, comparator, filterName, filterStatus, filterRole }) {
  ...
  if (filterName) {
    tableData = tableData.filter((item) => item.job_title.toLowerCase().indexOf(filterName.toLowerCase()) !== -1);
  }
...
//   const req = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/jobs`);
