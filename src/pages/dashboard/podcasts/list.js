...
import { PodcastsTableRow } from '../../../sections/@dashboard/podcasts';
...
export default function JobList({ data }) {
  ...
  return (
    <Page title="Podcasts: List">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading="Podcasts List"
          links={[
            { name: 'Dashboard', href: PATH_DASHBOARD.root },
            { name: 'Podcasts', href: PATH_DASHBOARD.podcasts.root },
            { name: 'List' },
          ]}
          action={
            <NextLink href={PATH_DASHBOARD.podcasts.new} passHref>
...
export async function getStaticProps() {
  const req = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/articles/podcasts`);
