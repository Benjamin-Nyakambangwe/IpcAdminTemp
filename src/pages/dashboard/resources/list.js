...
import { ResourcesTableRow } from '../../../sections/@dashboard/resources';
...
export default function BlogList({ data }) {
  ...
  const handleEditRow = (id) => {
    push(PATH_DASHBOARD.resources.edit(paramCase(id)));
  };
    ...
    <Page title="Resources: List">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          action={
            <NextLink href={PATH_DASHBOARD.resources.new} passHref>
