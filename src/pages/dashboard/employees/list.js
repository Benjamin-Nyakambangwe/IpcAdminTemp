...
import { EmployeesTableRow } from '../../../sections/@dashboard/employees';
...
const TABLE_HEAD = [
  ...
  { id: 'resume', label: 'Resume', align: 'right' },
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            { name: 'Employees', href: PATH_DASHBOARD.employees.root },
            // { name: 'List' },
          ]}
        // action={
...
export async function getStaticProps() {
  const req = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/users/employees`);
