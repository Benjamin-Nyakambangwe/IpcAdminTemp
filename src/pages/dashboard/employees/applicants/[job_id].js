...
const TABLE_HEAD = [
  ...
  { id: 'academic_qualification', label: 'Qualification', align: 'left' },
  { id: 'experience', label: 'Experience', align: 'left' },
  { id: 'career_level', label: 'Career Level', align: 'left' },
...
export default function JobList({ data }) {
  ...
  const [tableData, setTableData] = useState(data.applicants);
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            { name: 'Jobs', href: PATH_DASHBOARD.blog.root },
            { name: 'Applicants' },
          ]}
          action={
