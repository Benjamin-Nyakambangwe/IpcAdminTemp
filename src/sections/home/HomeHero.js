        ...
        <Container>
          <ContentStyle>
            <m.div variants={varFade().inRight}>
              <Typography variant="h1" sx={{ color: 'common.white', textAlign: 'center' }}>
                Admin <br />
                Dashboard<br />
            ...
            <m.div variants={varFade().inRight}>
              <Typography sx={{ color: 'common.white', textAlign: 'center' }}>
                The starting point for your admin roles for ipc website, helping you mange the web faster and
                better.
              </Typography>
            </m.div>
