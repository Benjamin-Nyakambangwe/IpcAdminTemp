...
export default function VideosNewPostForm({ data }) {
  ...
  const submit = async (e) => {
    ...
    // formdata.append("date", "2019-12-13");
    // formdata.append("time", "");
    formdata.append("heading", values.heading);
    formdata.append("description", values.description);
    formdata.append("status", "1");
    // formdata.append("date_last_edited", "2021-10-20");
    // formdata.append("time_last_edited", "03:40:39");
    formdata.append("author", values.author.admin_id);
    formdata.append("video_link", slugify(values.heading));
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/articles/add-video`, requestOptions)
    const data = res.json()
    console.log(data)
