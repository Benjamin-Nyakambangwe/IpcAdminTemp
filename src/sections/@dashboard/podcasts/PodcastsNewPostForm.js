...
export default function ResourcesNewPostForm({ data }) {
  ...
  const submit = async (e) => {
    ...
    formdata.append("podcast_link", slugify(values.heading));
    formdata.append("cover", values.cover);
    formdata.append("new_audio", podcastFile);
    // formdata.append("date", "2022-10-20 06:34:38");
    // formdata.append("updated_time", "2022-10-20 06:34:38");
    // formdata.append("audio", "not avaialble");
    // formdata.append("featuredimage", "not available");
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/articles/add-podcast`, requestOptions)
    const data = res.json()
    console.log(data)
    ...
    // formdata.append("cover", values.cover);
    // formdata.append("pdf_file", podcastFile);
            ...
            <Card sx={{ p: 3 }}>
              <Stack spacing={3}>
                ...
                <div>
                  ...
                  <RHFUploadSingleFile name="podcastFile" accept="pdf/*" onDrop={handleDropFile} />
                </div> */}
