...
export default function EventsNewPostForm({ data }) {
  ...
  const submit = async (e) => {
    ...
    // formdata.append("date", "2021-10-22");
    // formdata.append("time", "11:30");
    formdata.append("event_link", slugify(values.heading));
    // formdata.append("date_time", "2021-10-22 07:12:48");
    // formdata.append("date_updated", "2022-10-22 07:12:48");
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/articles/add-event`, requestOptions)
    const data = res.json()
    console.log(data)
